...
def total_enrollment(usa):
    total_students = 0
    total_fees = 0
    for university_inform in usa:
        total_students = total_students + university_inform[1]
        total_fees = total_fees + university_inform[1] * university_inform[2]
